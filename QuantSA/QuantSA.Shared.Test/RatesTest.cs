...
namespace QuantSA.Shared.Test
{
    ...
    public class RatesTest
    {
        ...
        {
            var anchorDate = new Date(2016, 08, 30);
            var jibar = 0.075;
            var fraDescriptions = new[]
                {"1x4", "2x5", "3x6", "4x7", "5x8", "6x9", "7x10", "8x11", "9x12", "12x15", "15x18", "18x21", "21x24"};
            var fraRates = new[]
            {
                0.0750, 0.0752, 0.0759, 0.0761, 0.0768, 0.0770, 0.0775, 0.0776, 0.0780, 0.0781, 0.0783, 0.0784, 0.0785
            };
            var swapTenors = new[]{3, 4, 5, 6, 7, 8, 9, 10, 12, 15, 20};
